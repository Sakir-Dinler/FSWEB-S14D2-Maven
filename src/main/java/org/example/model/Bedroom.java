...
public class Bedroom {
    ...
    Bu sınıfın 10 tane instance variable değeri olmalı. name String tipinde. wall1 wall2 wall3 wall4 Wall tipinde
    . ceiling Ceiling tipinde. bed Bed tipinde. lamp Lamp tipinde. wardrobe Wardrobe tipinde. carpet Carpet tipinde.
